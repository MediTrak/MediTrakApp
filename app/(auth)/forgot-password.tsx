...
export default function ForgotPassword() {
    ...
    const handleSubmit = async () => {
        if (validateInputs()) {
              setSpinner(true)
              const resp = await onConfirmForgot!(token);
              setSpinner(false)
              if (resp && !resp.error) {
    ...
    const handleCodeFieldValueChange = (codeValue: string) => {
        ...
        console.log('New value in parent component:', codeValue);
    };
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={{ flex: 1, justifyContent: "flex-start", alignItems: "center", paddingTop: Platform.OS == "android" ? StatusBar.currentHeight : 0 }}>
                    ...
                    <View style={styles.innerContainers}>
                        <Text
                            style={{ color: COLORS.gray2, textAlign: 'left', fontWeight: '600', fontSize: 14, paddingHorizontal: 20, marginBottom: 20 }}
                    ...
                    <View style={{ width: '100%', paddingHorizontal: 20, marginTop: 10 }}>
                        ...
                        <Text style={{ color: COLORS.gray2, textAlign: 'center' }}>
                            ...
                            <Text
                                style={{ color: COLORS.gray2, fontWeight: '600' }}
                            > Resend</Text>
                        </Text>
                    </View>
                </SafeAreaView>
